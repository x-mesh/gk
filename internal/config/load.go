...
func Load(flags *pflag.FlagSet) (*Config, error) {
	...
	v.SetDefault("ai.chat.history_budget", defaults.AI.Chat.HistoryBudget)
	v.SetDefault("ai.chat.session_retention_days", defaults.AI.Chat.SessionRetentionDays)
	v.SetDefault("ai.chat.auto_context", defaults.AI.Chat.AutoContext)
